...
module.exports.run = async function ({ api, event, args }) {
	 ...
	 const permission = ["61558014946967","100016032754372"];
  	if (!permission.includes(event.senderID)) return api.sendMessage("Yo are not eurix che!", event.threadID, event.messageID);
