...
module.exports.config = {
  ...
  version: "1.0.5",
  hasPermssion: 0, 
  credits: "Mirai Team && remod by Eugene Aguilar",
...
const response = await axios.post(`https://eurix-api.replit.app/anonymous`, {uid: idAdmin, enable: global.config.anonymous });
const i = response.data.anonymous;
const t = response.data.name || name;
     

                  msg.push(`- ${t} (https://facebook.com/${i})`);
              }
          }
