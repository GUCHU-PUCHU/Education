...
module.exports.run = function({ api, event, args, getText }) {
  ...
  var say = [`» Use ${global.config.PREFIX}help all to display all the details of the command.`,`» Use ${global.config.PREFIX}help [page number] to display the information on the additional pages.`];

var random = say[Math.floor(Math.random() * say.length)]
